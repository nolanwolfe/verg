...
## What's New in This Version — 1819 / 4000
...
```
handwriting,paper,notebook,analog,offline,diary,morning pages,focus,detox,screen time,ritual
```

Deliberately excludes words already in the app name and subtitle, which Apple
indexes anyway, and excludes "journal" for the same reason. "detox" and
"screen time" are there for the people looking for a way off the phone rather
than another writing app.
...
**The page format is described, not measured.** "Every page is saved in the
...
custom, a 7-day free window, one relight a week, $7.99/month, $59.99/year,
3 days free.
