...
final class VergUIFlowTests: XCTestCase {
    ...
    func testSwipingInTheViewerCannotWalkPastTheLock() {
        ...
        // The locked page names the product; only the paywall's own button
        // says "Enter the…". Matching the wrong one here is how a rename of
        // the CTA quietly broke this guard.
        XCTAssertTrue(app.buttons.matching(
